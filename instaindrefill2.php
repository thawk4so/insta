    ...
    if (!empty($results)) { 
        ...
        */
        ...
        if (!empty($json_status)) {
            ...
            $update_query = "UPDATE insta_ft_col SET recent_access_id = '{$recent_id}', break_access_id = '{$input_break_id}', break_status = {$break_status}, account_existence = {$check_account_id_flag}   WHERE id = {$account_id}";
            echo $update_query."\n";     
