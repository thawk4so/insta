...
$query = "SELECT * FROM insta_ft_col WHERE api_status = 1 ORDER BY id ASC";
...
foreach ($results as $iaccount) { 
    ...
    $update_query = "UPDATE insta_ft_col SET api_status = 0 and last_access_id = '{$last_feed['id']}' WHERE id = {$iaccount['id']}";
